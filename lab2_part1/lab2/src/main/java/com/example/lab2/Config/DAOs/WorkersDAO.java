...
public class WorkersDAO implements DAO<Workers>{
    ...
    public Optional<Workers> get(int id) throws DAOException {
        ...
        try {
            ...
            worker = entityManager.createNamedQuery("Workers.findById", Workers.class).setParameter("id", id).getSingleResult();
    ...
    public List<Workers> getAll() throws DAOException {
        ...
        try{
            ...
            workers = entityManager.createNamedQuery("Workers.findAll", Workers.class).getResultList();
    ...
    public void updateWorker(int employment, int id){
        ...
        try {
            transaction.begin();
            entityManager.createNamedQuery("Workers.updateEmployment")
                    .setParameter("em", employment)
